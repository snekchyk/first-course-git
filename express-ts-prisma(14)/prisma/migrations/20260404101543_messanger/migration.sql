/*
  ...
  - A unique constraint covering the columns `[age,name]` on the table `Users` will be added. If there are existing duplicate values, this will fail.
...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_favoritedById_fkey" FOREIGN KEY ("favoritedById") REFERENCES "Users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
